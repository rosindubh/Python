...
list_of_questions = [
    ...
    Correct! The solid colour for of oxygen is infact blue.
     ''','''
    Incorrect! The solid colour for of oxygen is infact blue
    ''','d', False],
    ...
    ''','''
    Correct - Despite his portrayal in the hit musical 'Hamilton' Thomas Jefferson only 
    gave two speeches in his life and even then audiences had to strain to hear him. 
    This was despite kicking ass as the ambassador to France.
    ''','''
    ...
    C)Furry                             D)Feathery
    ''','''
    Correct - Recent research suggests that dinosaurs, as they were more closely related to birds were feathered.
    Even the fearsome T-Rex is considered to have had feathers along it's head, neck and tail. The velociraptor 
    was about the size of a chicken and feathered as such. Clever girl...
    ''','''
...
def gameover():
        print_str('''
    You fall backwards into the abyss falling for what seems at first like an eternity but rather
    than speed up you seem to slow down until you are gently laid in a heap. You breathe but cannot
    distinguish where the air, if there is any air, begins and your body ends. You pick yourself up
    and find that you are intact, with no bruises or scars. You look down and find yourself naked,
    but you are not embarrassed or ashamed. You feel comfortable, as if in a warm bath.

    You walk forward, trying to find the walls of the blackness, but find nothing. Your eyes never
    seem to adjust, and you wonder how you can see your body below you, but nothing else. You walk for
    what might be a day or only a minute, there is no way for you to tell. Faintly you hear running
    water and walk towards the sound of the source. You come to a river with a fast-flowing current.
    It is wide, too wide to cross by swimming. Out of the darkness melts a small boat paddled by a
    figure with a single oar.

    As it draws closer you see that it is in fact a hooded skeleton.
    You are not afraid, however. The small boat comes to shore and the man stays still, his oar on
    the bank ready to push off. You obligingly step on board, more by instinct, as if you have been
    waiting for this journey for a long time. Once settled in the boat, the figure pushes off. You
    look only forward to your destination and the world dissolves away into half remembered stories.
...
def game_win():
    ...
    You open the door and are blinded by the light. Squinting you step out of the building and a
    fresh gust of air fills your lungs. Night is turning to day, and as your eyes adjust you see
    the light slanting through the trees, filtering out the darkness from the night before.
    Somewhere a bird bursts into raucous song. You look up and see the reassuring blue of a
    cloudless sky. The wind rustles the trees and the air warms sympathetically. No more questions,
    no more monsters. You step out onto the long unkept grass and watch the grasshoppers leap away.
    The building once looming monstrously large and forbidding behind you, takes on a much meeker
    stance. Like an old abusive parent now withered down with age. Cataract windows staring out like
    unseeing eyes. Cracks in the brick work like wrinkles tracing their way across the façade of
    respectability. Odd patches of mould and ivy darkening the facade like liver spots and errant
    growths of hair. The smell of decay and dust, the smell of waiting to be condemned. The building
    creaks and grumbles with unease at the things it houses. You walk away free into the wood warmed
    by the rising sun.\n    ''')
